Shader "Grid/GreenWireframe"
{
	Properties
	{
		[PowerSlider(3.0)]
		_WireframeVal("Wireframe width", Range(0., 5.)) = 0.2
		_Color("Wire Color", Color) = (1, 0.1, 0.1, 1)
		_Antialias("Fill", Range(0., 10.)) = 1.5
	}
		...
		SubShader
		{
			...
			Pass
			{
				...
				void geom(triangle v2g IN[3], inout TriangleStream<g2f> triStream) {
					...
					g2f o;
					o.lineColour = (float4) ((IN[0].cameraToSurfaceNormalAngleDegrees / 90) * _Color);
				...
				fixed4 frag(g2f i) : SV_Target {
					...
					minBary = smoothstep(0, _Antialias * delta, minBary);
